...
let myGreeting = new Greeting ('Jennifer', 'Boise, ID')
myGreeting.hello()
...
//new book: yourBook
let yourBook = new Book ('Tender is the Night', 'F. Scott Fitzgerald')
//print new, yourBook
console.log(yourBook.describe());
//That was so much easier than I though, and i had to use the walkthrough to get through it because
//I was trying to make it harder than it was.  
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
//the word "name" had a line through is and says it is "Deprecated" I was going to change it, 
//but then the rest of the code doesnt work, so i left it. 
class Fruit{
...
console.log(newStudent.introduction());
console.log(newStudent.details());
console.log(newTeacher.introduction());
console.log(newTeacher.details());
 ...
 * (make sure to fill in the title and director programmatically): "The movie [movie name here] was directed by [director name here]."
 ...
 * oof. 
 * Step 6: Create two instances of Movie called movie1, use "Jurassic Park" and "Steven Spielberg" as it's arguments AND movie2, 
